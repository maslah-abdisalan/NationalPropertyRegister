package com.luulsolutions.property.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("natproreg");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("natproreg");
        ...
        config.getMapConfigs().put("com.luulsolutions.property.domain.*", initializeDomainMapConfig(jHipsterProperties));
